<h2><a href="https://www.geeksforgeeks.org/problems/power-of-2-1587115620/1?page=1&status=unsolved&sortBy=submissions">Power of 2</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Given a non-negative integer <strong>n</strong>. You have to check if it is a power of <strong>2 </strong>or not.&nbsp; <br></span></p>
